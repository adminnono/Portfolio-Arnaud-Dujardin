...
import projects from "../constants/projets.json";
    ...
    >
      <div className="relative group">
        ...
        <button onClick={openModal} className="absolute inset-0 cursor-pointer">
          <span className="sr-only">Détails ouverts pour {project.title}</span>
        </button>
      </div>
    </animated.div>
  );  
...
export default function Projects() {
  ...
  return (
    ...
    >
      <h2 className="text-4xl font-bold text-darkDesert mb-4">Projets de formation & Wordpress</h2>
